...
this.userauth.pendingDoctor(this.pages).subscribe(res=>{
  // doctorName
  console.log(res.body.doctorEmail)
  console.log(res.body.doctorName)
...
//     });
    ...
    //     this.doctorfilter.deletedoctors(id).subscribe(data => {

    //       alert(`delete product ${id}`)
    //       this.doctorfilter.getalldoctors().subscribe(prdList=>{
    //         this.doctors=prdList;});
    //        });
