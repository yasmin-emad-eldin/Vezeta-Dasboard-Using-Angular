...
import{TablefilterService} from 'src/app/services/tablefilter.service'
@Component({
  selector: 'app-tables',
...
export class TablesComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.userauth.AcceptedDoctor(this.pages).subscribe(res=>{
  ...
  pageid(id:number){
    ...
    this.userauth.AcceptedDoctor(id).subscribe({next:(data)=> {
